...
uTexel: { value: new a.Vector2() }, uNear: { value: 0.25 }, uFar: { value: 600 }, uInk: { value: new a.Color(b.ink) }, uThickness: { value: 1.35 }, uSens: { value: 42e-4 }, uConcave: { value: 0.026 }, uConcaveAmount: { value: 0.42 }, uFadeStart: { value: 40 }, uFadeEnd: { value: 98 }, uStrength: { value: 1 }, uSkyDepth: { value: 420 } }, vertexShader: `
  ...
  ` }, Mn = { uniforms: { tDiffuse: { value: null }, uShadowTint: { value: new a.Color(11380944) }, uLightTint: { value: new a.Color(16775144) }, uSaturation: { value: 1.12 }, uLift: { value: 0.032 }, uVignette: { value: 0.15 }, uWarmth: { value: 0.05 } }, vertexShader: Qe.vertexShader, fragmentShader: `
    uniform sampler2D tDiffuse;
  ...
  ` }, zn = { uniforms: { tDiffuse: { value: null }, uTexel: { value: new a.Vector2() } }, vertexShader: Qe.vertexShader, fragmentShader: `
    uniform sampler2D tDiffuse;
    uniform vec2 uTexel;
    varying vec2 vUv;
...
const oo = { 2: [96, 255], 3: [92, 178, 255], 4: [80, 142, 202, 255], 5: [74, 124, 172, 214, 255], soft: [180, 255], soft3: [172, 214, 255] }, Be = /* @__PURE__ */ new Map();
function kn(e = 3) {
  const t = e;
  if (Be.has(t)) return Be.get(t);
  const o = oo[e] || oo[3], n = new Uint8Array(o.length * 4);
...
const Ho = "lights_toon_pars_fragment", no = "vec3 irradiance = getGradientIrradiance( geometryNormal, directLight.direction ) * directLight.color;", Sn = `
...
let Uo = false, jo = "";
{
  ...
  e && e.includes(no) && (jo = `uniform vec3 uShadowTint;
` + e.replace(no, Sn), Uo = true);
}
function Gn(e, t) {
  if (!Uo) return e;
...
function g(e = {}) {
  ...
  return h !== null && (A.depthWrite = h), Gn(A, n), G && Pe.set(G, A), A;
}
...
function P(e = {}) {
  ...
  if (d && De.has(d)) return De.get(d);
  const h = new a.MeshBasicMaterial({ color: t, map: o, transparent: n, opacity: s, side: r, alphaTest: c, fog: l, toneMapped: u });
  return i !== null && (h.depthWrite = i), d && De.set(d, h), h;
}
const Ae = "'Yu Gothic', 'Yu Gothic UI', 'Meiryo', 'MS Gothic', 'Hiragino Kaku Gothic ProN', sans-serif", Le = /* @__PURE__ */ new Map();
...
function Tt(e, t) {
  return Le.has(e) || Le.set(e, t()), Le.get(e);
}
const Vt = (e) => "#" + e.toString(16).padStart(6, "0");
function Tn(e, t, o, n, s = Ae, r = "bold") {
  let c = n;
  do {
...
function Yt(e, t, o, n, s, r, c, i = "bold", l = 0) {
  const f = Tn(e, t, s, r, Ae, i);
...
function An(e, t, o, n, s, r, c) {
  e.font = `bold ${r}px ${Ae}`, e.fillStyle = c, e.textAlign = "center", e.textBaseline = "middle", [...t].forEach((i, l) => e.fillText(i, o, n + l * s));
}
const Cn = () => Tt("crossingSign", () => Gt(512, 256, (e, t, o) => {
  e.fillStyle = "#fbf8f2", e.fillRect(0, 0, t, o), e.strokeStyle = Vt(b.black), e.lineWidth = 12, e.strokeRect(6, 6, t - 12, o - 12), Yt(e, "LEVEL CROSSING", t / 2, o * 0.36, t - 60, 84, Vt(b.redDeep), "bold", 6), Yt(e, "STOP \xB7 LOOK \xB7 LISTEN", t / 2, o * 0.74, t - 80, 42, Vt(b.black), "bold", 2);
})), Rn = () => Tt("stationSign", () => Gt(768, 192, (e, t, o) => {
  e.fillStyle = "#fbfaf6", e.fillRect(0, 0, t, o), e.fillStyle = Vt(b.teal), e.fillRect(0, o - 22, t, 22), Yt(e, "\u0C35\u0C3F\u0C26\u0C4D\u0C2F\u0C3E\u0C28\u0C17\u0C30\u0C4D", t / 2, o * 0.42, t * 0.7, 92, "#2b3346", "bold", 12), e.font = `600 34px ${Ae}`, e.fillStyle = "#8a8fa0", e.textAlign = "center", e.fillText("VIDYANAGAR", t / 2, o * 0.82);
...
})), In = () => Tt("trainDest", () => Gt(512, 128, (e, t, o) => {
  e.fillStyle = "#1d2230", e.fillRect(0, 0, t, o), e.fillStyle = "#f2e6b0", e.fillRect(10, 22, 110, 84), Yt(e, "MMTS", 65, 64, 96, 40, "#1d2230", "bold"), Yt(e, "VIDYANAGAR", t * 0.62, o / 2, t * 0.55, 64, "#f2e6b0", "bold", 6);
})), En = () => Tt("trainNumber", () => Gt(256, 96, (e, t, o) => {
  e.fillStyle = "#f7f2e6", e.fillRect(0, 0, t, o), Yt(e, "MMTS 2104", t / 2, o / 2, t - 20, 50, "#4a4657");
...
}, { repeat: [1, 1] })), Bn = () => Tt("platePlate", () => Gt(256, 128, (e, t, o) => {
  e.fillStyle = "#f6f4f0", e.fillRect(0, 0, t, o), e.strokeStyle = "#4f5a72", e.lineWidth = 8, e.strokeRect(8, 8, t - 16, o - 16), Yt(e, "\u3055 21-08", t / 2, o / 2, t - 40, 56, "#2f3646");
})), Pn = () => Tt("petalTex", () => Gt(128, 128, (e, t, o) => {
...
const Ln = new a.Matrix4(), ao = new a.Quaternion(), so = new a.Euler(), ro = new a.Vector3(), io = new a.Vector3();
function T(e = 0, t = 0, o = 0, n = 0, s = 0, r = 0, c = 1, i = 1, l = 1) {
  return ro.set(e, t, o), so.set(n, s, r), ao.setFromEuler(so), io.set(c, i, l), Ln.clone().compose(ro, ao, io);
}
...
function Nn(e, t = 500) {
  ...
  const r = Dn(), c = nt(7781), i = new a.Group(), l = P({ color: b.cloud, map: r, transparent: true, opacity: 0.62, depthWrite: false, fog: false, cache: false }), f = P({ color: b.cloudShade, map: r, transparent: true, opacity: 0.34, depthWrite: false, fog: false, cache: false });
...
const O = 3.15, K = 1.55, Lt = 0.135, On = 0.015, _t = -80, Nt = 80, bt = 2.2, Se = 2.95, Pt = 3.35;
function U(e) {
  let t = 0;
...
function Vn(e, t) {
  ...
  return Math.abs(t) < Pt ? false : o > O - 0.02 && o < O + K;
}
function co(e, t) {
...
const $o = { z: -24 }, Ue = -98, je = 106;
function Wn(e, t) {
  return false;
}
const $ = 160, ht = 2 * Math.PI * $, ot = new a.Vector3(0, -$, 0), Q = new a.Vector3(), he = new a.Quaternion(), pe = new a.Vector3(), me = new a.Matrix4();
function Hn(e, t, o = new a.Vector3()) {
  const n = e / $, s = t / $, r = Math.cos(s);
  return o.set(Math.sin(n) * r, Math.cos(n) * r, Math.sin(s));
}
function $t(e, t, o, n = new a.Vector3()) {
  return Hn(e, o, n).multiplyScalar($ + t).add(ot), n;
}
function te(e, t, o = new a.Vector3(), n = new a.Vector3(), s = new a.Vector3()) {
  const r = e / $, c = t / $, i = Math.sin(r), l = Math.cos(r), f = Math.sin(c), u = Math.cos(c);
  return o.set(i * u, l * u, f), n.set(l, -i, 0), s.set(-i * f, -l * f, u), { up: o, east: n, north: s };
}
function Xo(e, t = { x: 0, z: 0, y: 0 }) {
  Q.copy(e).sub(ot);
  const o = Q.length() || 1;
  return Q.multiplyScalar(1 / o), t.z = $ * Math.asin(a.MathUtils.clamp(Q.z, -1, 1)), t.x = $ * Math.atan2(Q.x, Q.y), t.y = o - $, t;
}
function Qo(e, t) {
  let o = e - t;
  for (; o > ht / 2; ) o -= ht;
...
function Un(e, t) {
  ...
  for (let u = 0; u < 12; u++) {
    ...
    for (let w = 0; w < c; w += 3) {
      let M = -1, G = 0;
      for (let y = 0; y < 3; y++) {
        const k = w + y, I = w + (y + 1) % 3, v = d[k * 3] - d[I * 3], z = d[k * 3 + 1] - d[I * 3 + 1], R = d[k * 3 + 2] - d[I * 3 + 2], F = v * v + z * z + R * R;
        F > M && (M = F, G = y);
      }
      if (M <= n) {
        for (const y of p) {
          const k = r.find((I) => I.name === y.name).src;
          for (let I = 0; I < 3; I++) for (let v = 0; v < y.size; v++) y.dst.push(k[(w + I) * y.size + v]);
        }
        m.push(l[w / 3]);
        continue;
      }
      ...
      for (const y of p) {
        const k = r.find((z) => z.name === y.name).src, I = [];
        for (let z = 0; z < y.size; z++) I.push((k[A * y.size + z] + k[x * y.size + z]) * 0.5);
        const v = (z) => {
          for (let R = 0; R < y.size; R++) y.dst.push(k[z * y.size + R]);
        };
        v(A), y.dst.push(...I), v(S), y.dst.push(...I), v(x), v(S);
      }
    }
...
function jn(e, t = 3) {
  ...
  for (let r = 0; r < n.count; r++) $t(n.getX(r), n.getY(r), n.getZ(r), s), n.setXYZ(r, s.x, s.y, s.z);
...
function Kn(e, { maxEdge: t = 3 } = {}) {
  ...
  for (const { obj: i, world: l } of s) {
    if (i.isInstancedMesh) {
      ...
      for (let d = 0; d < f; d++) {
        ...
        const h = te(Q.x, Q.z), p = new a.Quaternion().setFromRotationMatrix(new a.Matrix4().makeBasis(h.east, h.up, h.north)), m = $t(Q.x, Q.y, Q.z, new a.Vector3());
  ...
  for (const { obj: i, world: l } of n) {
    l.decompose(Q, he, pe);
    const f = te(Q.x, Q.z);
    c.makeBasis(f.east, f.up, f.north), i.position.copy($t(Q.x, Q.y, Q.z, new a.Vector3())), i.quaternion.setFromRotationMatrix(c).multiply(he), i.scale.copy(pe);
  }
  return r;
}
function qn(e, t) {
...
function $n(e) {
  const t = new a.Group();
  t.name = "planet";
  const o = new a.IcosahedronGeometry($, 30), n = o.attributes.position, s = new a.Vector3(), r = { x: 0, z: 0, y: 0 }, c = new a.Vector3();
  for (let l = 0; l < n.count; l++) {
    s.set(n.getX(l), n.getY(l), n.getZ(l)).normalize(), c.copy(s).multiplyScalar($).add(ot), Xo(c, r);
    const f = qn() + et() * 0.999 - On - 0.065;
    c.copy(s).multiplyScalar($ + f).add(ot), n.setXYZ(l, c.x, c.y, c.z);
  }
  n.needsUpdate = true, o.deleteAttribute("normal"), Yn(o);
  {
...
class oa {
  ...
  update(t) {
    ...
    const u = this.world.heightAt(this.pos.x, this.pos.z), d = this.world.colliders, h = 1 / Math.max(0.25, Math.cos(this.pos.z / $)), p = this.vel.x * t * h, m = this.vel.z * t, w = Math.max(1, Math.ceil(Math.max(Math.abs(p), Math.abs(m)) / 0.18));
    for (let y = 0; y < w; y++) this.pos.x += p / w, this._resolve(d, u), this.pos.z += m / w, this._resolve(d, u);
    if (n) {
      const y = this._probe.copy(this.pos).addScaledVector(this._forward, Ot.nose), k = y.x, I = y.z;
      this._resolveAt(y, d, u, Ot.noseR), this.pos.x += y.x - k, this.pos.z += y.z - I, this._resolve(d, u);
    }
...
function na({ volume: e = 0.34 } = {}) {
  const t = (z, R, F, H) => {
    ...
    return R && (C.className = R), H !== void 0 && (C.innerHTML = H), (F || document.body).appendChild(C), C;
  ...
  G(e);
  let A = 0, x = true, S = null, y = false, k = 0, I = false;
  const v = { root: o, overlay: h, onStart: null, onVolumeChange: null, flash(z, R = 1400) {
    ...
    z && (I = true), h.dataset.mode = I ? "paused" : "start", h.classList.toggle("hidden", z), h.setAttribute("aria-hidden", z ? "true" : "false"), n.classList.toggle("on", z), z ? (A = 0, x = true, f.classList.remove("faded")) : requestAnimationFrame(() => p.focus({ preventScroll: true }));
  }, setVolume(z) {
    G(z);
  }, setMuted(z) {
    ...
    k = 0;
    const C = (B, j = 2) => B.toFixed(j);
    let L = R % (Math.PI * 2);
    L > Math.PI && (L -= Math.PI * 2), L <= -Math.PI && (L += Math.PI * 2);
    const E = ["north +z", "north-west", "west -x", "south-west", "south -z", "south-east", "east +x", "north-east"][((4 - Math.round(L / (Math.PI * 2) * 8)) % 8 + 8) % 8];
    d = `{ pos: [${C(z.x, 1)}, 0, ${C(z.z, 1)}], yaw: ${C(L)}, pitch: ${C(F)} }`, u.innerHTML = `<span class="k">x</span>${C(z.x)} <span class="k">z</span>${C(z.z)} <span class="k">y</span>${C(z.y)}<br><span class="k">yaw</span>${C(L)} <span class="k">pitch</span>${C(F)} <span class="d">${E}</span><br><span class="s">${d}</span><br><span class="d">click or Shift+C to copy</span>`;
  }, copyCoords() {
    if (!d) return false;
  ...
  return w.addEventListener("input", () => {
    ...
    c.innerHTML = `<button class="card-close" aria-label="close">\u2715</button>
      <h3></h3><p></p>`, c.querySelector("h3").textContent = z, c.querySelector("p").textContent = R, c.classList.add("on"), i = true, c.querySelector(".card-close").addEventListener("click", (F) => {
      F.stopPropagation(), v.hideCard();
    });
  }, v.hideCard = () => {
    c.classList.remove("on"), i = false;
  }, v.cardIsOpen = () => i, window.addEventListener("keydown", (z) => {
    z.code === "Escape" && i && v.hideCard();
  }), v.bindTouch = ({ player: z, onPlanet: R, onMusic: F, onEnter: H }) => {
    const C = (E, B) => {
      const j = E.dataset.key, lt = E.dataset.act;
      j && (B ? z.touchPress(j) : z.touchRelease(j)), B && (lt === "interact" && z.touchInteract(), lt === "planet" && R?.(), lt === "music" && F?.());
    };
    l.querySelectorAll(".tbtn").forEach((E) => {
      E.addEventListener("pointerdown", (B) => {
        B.preventDefault(), C(E, true);
      }), E.addEventListener("pointerup", () => C(E, false)), E.addEventListener("pointercancel", () => C(E, false)), E.addEventListener("pointerleave", () => C(E, false));
    });
    const L = document.getElementById("view");
    let V = null;
    L.addEventListener("touchstart", (E) => {
      E.touches.length === 1 && (V = { x: E.touches[0].clientX, y: E.touches[0].clientY }, H?.());
    }, { passive: true }), L.addEventListener("touchmove", (E) => {
      if (!V || E.touches.length !== 1) return;
      const B = E.touches[0];
      z.touchLook(B.clientX - V.x, B.clientY - V.y), V = { x: B.clientX, y: B.clientY }, E.preventDefault();
...
const rt = 3.4, sa = 7, ra = 17, lo = sa, fo = ra, ia = 5.5, ze = [{ x: 161, z: -45.2, bank: 0.5, dr: 14, dm: 2.5, cr: 2.2, fa: 0.48 }, { x: 154, z: -48.8, bank: 0.5, dr: 15, dm: 2.6, cr: 2.2, fa: 0.48 }, { x: 147.2, z: -52.2, bank: 0.46, dr: 14, dm: 2.5, cr: 4.2, fa: 0.46, hi: 10 }, { x: 143.6, z: -60, bank: 0.26, dr: 16, dm: 2.6, cr: 5.6, fa: 0.46, hi: 12, ho: 24 }, { x: 142.4, z: -70, bank: 0.21,
...
dm: 2.4, cr: 6.4, fa: 0.44 }, { x: 199, z: -39.4, bank: 0.28, dr: 20, dm: 2.5, cr: 6.8, fa: 0.46 }, { x: 186, z: -39.6, bank: 0.28, dr: 20, dm: 2.5, cr: 7.2, fa: 0.46 }, { x: 174, z: -40.6, bank: 0.3, dr: 18, dm: 2.5, cr: 7.2, fa: 0.46 }, { x: 166, z: -42.4, bank: 0.36, dr: 16, dm: 2.5, cr: 6, fa: 0.46 }], Ze = ze.map((e, t) => {
  const o = ze[(t + 1) % ze.length], n = o.x - e.x, s = o.z - e.z;
  return { a: e, b: o, dx: n, dz: s, len: Math.hypot(n, s), l2: n * n + s * s || 1e-6, s0: 0 };
});
{
  let e = 0;
  for (const t of Ze) t.s0 = e, e += t.len;
}
const Ft = (() => {
...
function on(e, t) {
  ...
  return { d: c ? r : -r, bank: f(i.bank, l.bank), dr: f(i.dr, l.dr), dm: f(i.dm, l.dm), cr: f(i.cr, l.cr), fa: f(i.fa, l.fa), hi: f(i.hi ?? lo, l.hi ?? lo), ho: f(i.ho ?? fo, l.ho ?? fo), arc: n.s0 + n.len * s };
}
function ca(e, t) {
...
const dt = 1.5, wa = 2.6, Ne = 21, ya = [{ x: 24, z: -116, rx: 76, rz: 30, h: 8 }, { x: 72, z: -112, rx: 50, rz: 26, h: 7 }, { x: -30, z: -114, rx: 54, rz: 26, h: 7 }, { x: 30, z: -140, rx: 66, rz: 56, h: 16.5 }, { x: -26, z: -136, rx: 60, rz: 52, h: 14 }, { x: 86, z: -134, rx: 58, rz: 50, h: 14.5 }, { x: 22, z: -162, rx: 80, rz: 40, h: 17 }, { x: -84, z: -150, rx: 62, rz: 48, h: 14 }, { x: 104, z: -164,
...
rz: 32, h: 10 }, { x: 266, z: -76, rx: 34, rz: 42, h: 11 }, { x: 258, z: -118, rx: 34, rz: 34, h: 10.5 }, { x: 214, z: -152, rx: 56, rz: 34, h: 11.5 }, { x: 158, z: -146, rx: 42, rz: 32, h: 11 }, { x: 188, z: -106, rx: 21, rz: 18, h: 11 }], an = [{ x0: -68, x1: 88, z0: -80, z1: 114, r: 13 }, { x0: -6, x1: 94, z0: -96, z1: -60, r: 13 }, { x0: -84, x1: -64, z0: -32, z1: 4, r: 11 }], Ge = [{ id: "W",
x0: -132, x1: -96, zS: -15, zN: 24, zCrest: 2, crestMid: 17, crestEnd: 12.2, half: 3.3, spring: 3.2, arch: 3.3, walk: -1, bank: 1, narrowChannel: false, gateX: -84.5 }, { id: "E", x0: 108, x1: 138, zS: -15, zN: 21, zCrest: 0, crestMid: 13.2, crestEnd: 11.4, half: 3.3, spring: 3.2, arch: 3.3, walk: 1, bank: 0, narrowChannel: true, gateX: 85 }], sn = Ge.map((e) => ({ x0: e.x0, x1: e.x1, z0: e.zS, z1: e.
...
function ga(e, t) {
  ...
  for (const n of ya) {
    ...
    if (c >= 1) continue;
    const i = n.h * (1 - c) * (1 - c);
    if (o *= 1 - i / Ne, o <= 0) return Ne;
  }
  return Ne * (1 - o);
}
const uo = (e, t) => {
  let o = 0;
  for (const n of Ge) if (!(t && !t(n)) && (o = Math.max(o, yt(n.x0 - 44, n.x0 - 20, e) * yt(n.x1 + 44, n.x1 + 20, e)), o >= 1)) return 1;
  return o;
}, Ma = (e) => e.narrowChannel, ho = 8, za = (e) => yt(Ue - ho, Ue, e) * yt(je + ho, je, e);
function va(e, t) {
  const o = yt(7.5, 16 - 6.5 * uo(e), Math.abs(t)), n = 1 - za(e) * (1 - yt(6.5, 14 - 3 * uo(e, Ma), Math.abs(t - $o.z)));
  let s = Math.min(o, n);
  if (s <= 0) return 0;
  for (const r of an) {
...
function Sa(e, t) {
  return Yo(((e & 1023) << 10 ^ t & 1023) + 40503)() - 0.5;
}
const Ga = (() => {
  const e = nt(778213), t = [];
  for (let n = 0; n < 170; n++) {
...
const Aa = (() => {
  ...
  return t;
})(), Qt = 8, Ke = /* @__PURE__ */ new Map(), ue = (e, t) => e * 4096 + t;
for (const e of Aa) {
  ...
  for (let r = t; r <= o; r++) for (let c = n; c <= s; c++) {
    const i = ue(r, c);
    let l = Ke.get(i);
    l || Ke.set(i, l = []), l.push(e);
  }
}
function Ca(e, t) {
  const o = Ke.get(ue(Math.floor(e / Qt), Math.floor(t / Qt)));
  if (!o) return 0;
  let n = 0;
  for (const s of o) {
...
const Ea = (() => {
  ...
  return t;
})(), xe = 24, po = /* @__PURE__ */ new Map();
for (const e of Ea) {
  const t = Math.floor((e.x - e.rx) / xe), o = Math.floor((e.x + e.rx) / xe), n = Math.floor((e.z - e.rz) / xe), s = Math.floor((e.z + e.rz) / xe);
  for (let r = t; r <= o; r++) for (let c = n; c <= s; c++) {
    const i = ue(r, c);
    let l = po.get(i);
    l || po.set(i, l = []), l.push(e);
  }
}
const mo = { main: [[18, -94.5], [15.4, -98.4], [10, -101], [1, -103.4], [-9, -105.6], [-19, -108.4], [-26.5, -112.6], [-24, -117.6], [-14, -120], [-3, -122.4], [8, -126.4], [17, -131], [24.6, -135.6]], ridge: [[24.6, -135.6], [17, -137.6], [8, -138.2], [-1, -137.4], [-10, -136.2], [-18, -135]], deck: [[24.6, -135.6], [29.6, -135.2], [35.4, -135.4]], hokora: [[-26.5, -112.6], [-32, -111], [-37, -112]],
glade: [[-14, -120], [-18, -124.5], [-16, -129]], foot: [[13, -97.4], [26, -97.6], [40, -98], [54, -98.4], [68, -98.2], [80, -96.6], [86, -93.8]], toverW: [[-66, 22], [-70, 25.5], [-75, 26], [-79.5, 23], [-82.5, 19], [-84.5, 15.5], [-86, 12]], toverE: [[91, -18.8], [97.5, -18.2], [104, -17.4], [106, -16.6], [99, -15.6], [97.8, -14.8], [100.6, -13.6], [101.4, -12.4], [104, -12]] }, Ba = 1.1, Pa = 2.7,
xo = { lakeRoad: { flat: 2.7, fade: 5, pts: [[89, -60, 0], [89, -46, 0], [90.4, -36.4, 0], [96, -33.6, 0], [104, -32.4, 0.1], [112, -31.6, 0.6], [120, -31.4, 1.7], [130, -32, 3], [139, -33, 4.1], [147, -34, 5.1], [153, -35.2, 5.8], [157, -37, 6.3]] }, damRoad: { flat: 3.2, fade: 4.6, pts: [[157, -37, 6.3], [152.6, -39.2, 6.3], [148, -41.5, 6.3], [143, -44, 6.2], [140.4, -48, 5.9]] }, shoreRoad: { flat: 2.6,
...
252.6, -89], [252.8, -91.4]] } }, rn = (() => {
  ...
  for (const o of Object.keys(mo)) {
    const n = mo[o];
    for (let s = 0; s < n.length - 1; s++) t(n[s], n[s + 1], Ba, Pa, false);
  }
  for (const o of Object.keys(xo)) {
    const n = xo[o], s = n.pts[0].length > 2;
...
const Oe = -1.3 + 5e-3;
{
  ...
  for (let o = ft; o <= Ut; o++) for (let n = ut; n <= jt; n++) {
    ...
    let p = Ta(c, i) * l * (0.2 + 0.8 * d) + (Sa(o, n) * 0.21 * l + Ca(c, i) * f + Ia(c, i) * u) * h;
...
function Oa(e, t) {
  ...
  if (Math.abs(t) < 7.5 || e > Ue && e < je && Math.abs(t - $o.z) < 6.5) return true;
  for (const o of an) if (e >= o.x0 && e <= o.x1 && t >= o.z0 && t <= o.z1) return true;
  return false;
}
const se = 1.44, Fa = 0.3, Mt = -ht / 2, Ct = ht / 2, wo = -150, yo = 150, bo = () => g({ color: b.railMetal, bands: 3, tint: 6248568, flat: false }), go = () => g({ color: b.railHead, bands: 2, tint: 7301264 }), Va = () => g({ color: b.sleeper, bands: 3, tint: 6117496 }), Wa = () => g({ color: b.ballast, bands: 3, tint: 6643076 }), Ha = () => g({ color: b.gateYellow, bands: 3, tint: 9400400 }), Ua = () => g(
{ color: b.gateBlack, bands: 2, tint: 4932960 }), ln = () => g({ color: b.metal, bands: 3, tint: 6709392 }), dn = () => g({ color: b.metalDark, bands: 3, tint: 6051456 }), Mo = () => g({ color: b.cabinet, bands: 3, tint: 7301264 }), ja = () => g({ color: b.concrete, bands: 3, tint: 7301008 });
function Ka(e) {
  const t = new a.Group();
  ...
  }
  {
    ...
    let f = 0;
    for (let u = Mt; u < Ct; u += 0.62) Math.abs(u) < O + K + 0.6 || (l.position.set(u, 0.32, 0), l.rotation.set(0, 0, 0), l.updateMatrix(), i.setMatrixAt(f++, l.matrix));
  ...
  }
  {
    ...
    for (const i of [-1, 1]) {
      const l = new a.Mesh(c.clone(), bo());
      l.position.set((Mt + Ct) / 2, 0, i * se / 2), l.castShadow = true, l.receiveShadow = true, l.name = "rail", t.add(l);
      const f = D(r, 0.016, 0.09, go(), (Mt + Ct) / 2, 0.424, i * se / 2);
      f.userData.noOutline = true, t.add(f);
    }
    c.dispose();
  }
  {
    const r = O * 2 + K * 2 + 1, c = U(0), i = g({ color: 14341599, bands: 3, tint: 7301008 }), l = D(r, 0.28, se - 0.26, i, c, 0.18, 0);
    ...
    for (const u of [-1, 1]) {
      const d = u * se / 2, h = D(r, 0.12, 0.115, bo(), c, 0.36, d);
      h.receiveShadow = true, t.add(h);
      const p = D(r, 0.016, 0.09, go(), c, 0.424, d);
  ...
  const o = bt + 1.05, n = O + K + 0.5;
  {
    ...
    }, u = [...f(o, wo + 22, -n), ...f(o, n, yo - 22), ...f(-o, wo + 22, -n), ...f(-o, n, 13.5), ...f(-o, 39.5, yo - 22)];
  ...
  }
  {
    ...
    for (let d = Mt + i; d <= Ct - i * 0.5; d += i) {
      if (Math.abs(d) < 8 || Ge.some((p) => d > p.x0 - 16 && d < p.x1 + 16)) continue;
...
function qa(e, t) {
  ...
  const n = U(0), s = Ha(), r = Ua(), c = ln(), i = dn(), l = Mo(), f = [], u = [];
  function d(x) {
    const S = new a.Group(), y = 0.52, k = Math.round(x / y), I = new a.BoxGeometry(y, 0.17, 0.09), v = [], z = [];
    for (let H = 0; H < k; H++) {
      const C = T(y * (H + 0.5), 0, 0);
      (H % 2 === 0 ? v : z).push({ geometry: I, matrix: C });
    }
    const R = new a.Mesh(pt(v), s), F = new a.Mesh(pt(z), r);
    R.castShadow = F.castShadow = true, S.add(R, F);
    for (let H = 1; H < k - 1; H += 3) {
      const C = D(0.11, 0.11, 0.07, P({ color: b.signalOff }), y * (H + 0.5), -0.14, 0.06);
      C.userData.lamp = "arm", f.push(C), S.add(C), S.add(D(0.03, 0.12, 0.03, i, y * (H + 0.5), -0.05, 0.06));
    }
    return wt(R, { thickness: 32e-4 }), wt(F, { thickness: 32e-4 }), I.dispose(), S;
  }
  function h(x, S, y) {
    const k = new a.Group(), I = n + x * (O + 0.42), v = S * Se;
    k.position.set(I, et(), v), k.userData.planetRigid = true;
    const z = D(0.66, 0.2, 0.62, ja(), 0, 0.1, 0);
    if (z.receiveShadow = z.castShadow = true, k.add(z), y === "arm") {
      const E = D(0.46, 0.92, 0.38, Mo(), 0, 0.66, 0);
      E.castShadow = E.receiveShadow = true, k.add(E), wt(E, { thickness: 34e-4 }), k.add(D(0.54, 0.07, 0.46, g({ color: b.cabinetTop, bands: 3 }), 0, 0.2 + 0.92 + 0.03, 0));
      for (let j = 0; j < 3; j++) k.add(D(0.48, 0.11, 0.4, j % 2 ? r : s, 0, 0.34 + j * 0.24, 0));
      const B = new a.Group();
      B.position.set(0, 0.2 + 0.92 + 0.12, S * 0.2), B.add(d(O * 2 + 0.5)), B.rotation.y = x > 0 ? Math.PI : 0, B.rotation.z = Math.PI / 2, k.add(B), u.push({ pivot: B }), k.add(D(0.2, 0.2, 0.14, i, 0, 0.2 + 0.92 + 0.12, S * 0.2));
    }
    const R = y === "arm" ? x * 0.44 : 0, F = 2.45, H = Jt(0.075, 0.09, F, 8, s, R, 0.2 + F / 2, 0);
    H.castShadow = true, k.add(H);
    for (let V = 0; V < 4; V++) k.add(Jt(0.082, 0.082, 0.22, 8, r, R, 0.42 + V * 0.56, 0));
    wt(H, { thickness: 32e-4 }), y === "arm" && k.add(D(0.5, 0.09, 0.09, i, R / 2, 0.2 + 0.5, 0));
    const C = new a.Group();
    C.position.set(R, 0.2 + F + 0.02, S * 0.02), C.rotation.y = S > 0 ? 0 : Math.PI, C.add(D(0.86, 0.13, 0.1, r, 0, 0.06, 0));
    for (const V of [-0.28, 0.28]) {
      const E = new a.Mesh(new a.CylinderGeometry(0.145, 0.16, 0.13, 12, 1, true), r);
      E.rotation.x = Math.PI / 2, E.position.set(V, -0.12, 0.07), C.add(E);
      const B = new a.Mesh(new a.CircleGeometry(0.16, 14), r);
      B.position.set(V, -0.12, 0), C.add(B);
      const j = new a.Mesh(new a.CircleGeometry(0.13, 14), P({ color: b.signalOff, cache: false }));
    ...
    if (L.rotation.x = Math.PI, L.position.set(0, 0.3, 0), C.add(L), k.add(C), y === "sign") {
      const V = [P({ color: b.wallWhite }), P({ color: b.wallWhite }), P({ color: b.wallWhite }), P({ color: b.wallWhite }), P({ color: 16777215, map: Cn(), cache: false }), P({ color: b.wallGray })], E = new a.Mesh(new a.BoxGeometry(1.15, 0.58, 0.05), V);
      E.position.set(0, 0.2 + F + 0.62, S * 0.05), E.rotation.y = S > 0 ? 0 : Math.PI, E.castShadow = true, k.add(E), wt(E, { thickness: 3e-3 });
      for (const B of [0.72, -0.72]) {
        const j = D(1.2, 0.15, 0.045, s, 0, 0.2 + F + 1.28, S * 0.05);
        j.rotation.z = B, j.castShadow = true, k.add(j);
      }
      k.add(Jt(0.06, 0.07, 1.3, 8, s, 0, 0.2 + F + 0.65, 0));
    }
    return o.add(k), e.collide(I - 0.4, v - 0.35, I + 0.4, v + 0.35, 2.4), k;
  }
  h(-1, 1, "arm"), h(1, -1, "arm"), h(1, 1, "sign"), h(-1, -1, "sign");
  {
    const x = -Se - 1.15, S = n - (O + 1.5), y = D(0.78, 1.32, 0.5, l, S, et() + 0.66, x);
    ...
    o.add(k);
    const I = D(0.52, 0.9, 0.4, l, S - 0.9, et() + 0.45, x + 0.1);
    I.castShadow = I.receiveShadow = true, o.add(I), o.add(D(0.6, 0.06, 0.46, g({ color: b.cabinetTop, bands: 3 }), S - 0.9, et() + 0.93, x + 0.1)), o.add(D(0.02, 1, 0.02, g({ color: b.metalDark, bands: 2 }), S, et() + 0.66, x - 0.26));
    const v = D(0.07, 0.07, 0.03, P({ color: b.signalRed }), S + 0.24, et() + 1.16, x - 0.26);
    ...
    const R = D(0.9, 1.6, 0.9, P({ color: 16711680, cache: false }), S, et() + 0.8, x);
  ...
  }
  {
    ...
    for (const S of [-1, 1]) {
      const y = n + S * (O + 0.15), k = D(0.34, 0.16, bt * 2 + 1.6, x, y, et() + 0.08, 0);
      ...
      for (const I of [-1, 1]) {
        ...
        v.rotation.x = -Math.PI / 2, v.position.set(n + S * (O + 0.82), et() + Lt + 0.016, I * (Pt + 0.32)), o.add(v);
      }
    }
  }
  ...
  const A = { group: o, arms: u, active: false, armT: 0, _blink: 0, request: null, setLamps(x, S) {
    ...
    const I = x && S < 0.5 ? p : m;
    w.forEach((v) => v.material.color.copy(I));
  }, setArms(x) {
    this.armT = x;
...
function Ya(e, t, o) {
  ...
  for (const m of [s + 4, r - 4.5]) {
    ...
    const M = new a.Mesh(new a.BoxGeometry(1.9, 0.5, 0.06), [P({ color: b.wallWhite }), P({ color: b.wallWhite }), P({ color: b.wallWhite }), P({ color: b.wallWhite }), P({ color: 16777215, map: Rn(), cache: false }), P({ color: b.wallGray })]);
  ...
  for (const m of [s + 2.5, (s + r) / 2 - 3.5, r - 2]) {
    ...
    M.position.set(m, l + 3.05, i + 0.5), n.add(M), n.add(D(0.18, 0.05, 0.18, P({ color: 16774100 }), m, l + 2.92, i + 0.5));
  }
  const p = new a.Mesh(new a.BoxGeometry(0.36, 0.72, 0.04), [P({ color: b.wallGray }), P({ color: b.wallGray }), P({ color: b.wallGray }), P({ color: b.wallGray }), P({ color: 16777215, map: Ko(1), cache: false }), P({ color: b.wallGray })]);
  return p.position.set(s + 8.5, l + 1, i + 0.02), p.rotation.y = Math.PI, n.add(p), n;
}
const Rt = 19.4, st = 2.86, zo = 20.1, It = 1.06, zt = 3.74, re = 3.96, $a = 4.88, W = {};
function Xa() {
  ...
  W.window = P({ color: b.trainWindow }), W.windowLit = P({ color: b.trainWindowLit }), W.door = g({ color: b.trainDoor, bands: 3, tint: 7301014 }), W.dark = g({ color: b.black, bands: 2, tint: 4932960 }), W.metal = g({ color: b.metalDark, bands: 3, tint: 6051456 }), W.wheel = g({ color: 4867410, bands: 2, tint: 4932960 }), W.headlight = P({ color: 16774874 }), W.tail = P({ color: 16734794 }));
}
...
function vo(e, t, o, n, s) {
  ...
  const f = 3.16 - 2.16, u = (h, p, m, w) => {
    const M = new a.Mesh(new a.PlaneGeometry(o - 0.06, p), P({ color: m }));
...
function ts({ cab: e = false, tail: t = false, rng: o }) {
  const n = new a.Group(), s = { body: [], stripe: [], roof: [], skirt: [], door: [], dark: [], metal: [] }, r = zt - It;
  s.body.push({ geometry: new a.BoxGeometry(Rt, r, st), matrix: T(0, (It + zt) / 2, 0) }), s.roof.push({ geometry: new a.BoxGeometry(Rt - 0.1, re - zt, st - 0.24), matrix: T(0, (zt + re) / 2, 0) });
  for (const d of [-1, 1]) s.roof.push({ geometry: new a.BoxGeometry(Rt - 0.05, 0.07, 0.1), matrix: T(0, zt + 0.02, d * (st / 2 - 0.06)) });
  const c = 1.92, i = 0.34;
  s.stripe.push({ geometry: new a.BoxGeometry(Rt + 0.02, i, st + 0.03), matrix: T(0, c, 0) }), s.stripe.push({ geometry: new a.BoxGeometry(Rt + 0.02, 0.07, st + 0.04), matrix: T(0, c - i / 2 - 0.055, 0) }), s.skirt.push({ geometry: new a.BoxGeometry(Rt - 0.3, 0.5, st - 0.34), matrix: T(0, It - 0.25, 0) }), s.skirt.push({ geometry: new a.BoxGeometry(Rt - 1.6, 0.28, st - 0.8), matrix: T(0, It - 0.52,
  0) });
  for (const d of [1, -1]) {
    for (const h of Qa) s.door.push({ geometry: new a.BoxGeometry(Za, zt - It - 0.12, 0.05), matrix: T(h, (It + zt) / 2 - 0.02, d * (st / 2 + 0.012)) }), s.dark.push({ geometry: new a.BoxGeometry(0.05, zt - It - 0.12, 0.06), matrix: T(h, (It + zt) / 2 - 0.02, d * (st / 2 + 0.02)) }), vo(n, h, 0.94, d, o);
    for (const [h, p] of Ja) s.metal.push({ geometry: new a.BoxGeometry(p + 0.12, 1.14, 0.035), matrix: T(h, 2.66, d * (st / 2 + 8e-3)) }), vo(n, h, p, d, o);
  }
  ...
  if (e || t) {
    ...
    const p = new a.Mesh(new a.PlaneGeometry(1.5, 0.38), P({ color: 16777215, map: In(), cache: false }));
    ...
    const m = new a.Mesh(new a.PlaneGeometry(0.8, 0.24), P({ color: 16777215, map: En(), cache: false }));
  ...
  if (e || t) {
    const d = new a.Group();
    d.position.set(e ? -4 : 4, re + 0.05, 0), d.scale.y = ($a - d.position.y) / 1.64, d.add(D(1.5, 0.08, 1.5, W.metal, 0, 0.04, 0));
    for (const h of [-1, 1]) {
...
function es(e) {
  ...
  for (let l = 0; l < 3; l++) {
    ...
    f.position.x = (l - 1) * zo, o.add(f), s.push(f), n.push(...u);
  }
  const r = new a.Matrix4().makeTranslation(ot.x, ot.y, ot.z), c = new a.Matrix4().makeTranslation(-ot.x, -ot.y, -ot.z);
  return { group: o, cars: s, wheels: n, length: zo * 3, dir: 1, x: 0, speed: 23.5, gust: 0, get offset() {
    return Qo(this.x, 0);
  }, planetize() {
    o.visible = true, o.matrixAutoUpdate = false, this.update(0);
  }, update(l) {
    this.x = gt(this.x + this.dir * this.speed * l), o.matrix.makeRotationZ(-this.x / $).premultiply(r).multiply(c), o.matrixWorldNeedsUpdate = true;
...
const ie = 980, ko = 6.8, ye = -30, be = 34, Et = 9.5;
function os(e) {
  const t = nt(8123), o = Pn(), n = new a.PlaneGeometry(0.185, 0.135), s = [{ color: b.petal, n: Math.round(ie * 0.55) }, { color: b.blossomLight, n: Math.round(ie * 0.28) }, { color: b.petalDeep, n: ie - Math.round(ie * 0.55) - Math.round(ie * 0.28) }], r = [], c = [];
  for (const p of s) {
    const m = P({ color: p.color, map: o, transparent: true, opacity: 0.95, depthWrite: false, side: a.DoubleSide, alphaTest: 0.32, cache: false }), w = new a.InstancedMesh(n, m, p.n);
  ...
  function h(p, m, w) {
    ...
    for (let A = 0; A < c.length; A++) {
      ...
      const k = U(x.z);
      x.x < k - Et && (x.x = k + Et), x.x > k + Et && (x.x = k - Et), x.z < ye && (x.z = be), x.z > be && (x.z = ye), x.y < et(x.z) + 0.04 && d(x), l.setFromAxisAngle(x.spin, x.angle), i.position.set(x.x, x.y, x.z), i.quaternion.copy(l), f.setScalar(x.scale), i.scale.copy(f), i.updateMatrix(), x.mesh.setMatrixAt(x.idx, i.matrix);
    }
...
function Ce(e, t, o, n) {
  ...
  return r.colorSpace = a.SRGBColorSpace, r.anisotropy = 4, Fe.set(e, r), r;
}
...
function ss(e, { bg: t = "#1d4e9c", fg: o = "#ffffff", name: n, telugu: s = "", strip: r = null }) {
  return Ce("fascia:" + e, 512, 128, (c, i, l) => {
...
function rs() {
  return Ce("busStop", 512, 192, (e, t, o) => {
...
function is() {
  return Ce("roadName", 512, 128, (e, t, o) => {
...
function ds(e) {
  ...
  for (const [l, f] of [[_t, -Pt], [Pt, Nt]]) {
    const u = Xt({ z0: l, z1: f, step: 1.6, a: (h) => ({ x: U(h) - O, y: i }), b: (h) => ({ x: U(h) + O, y: i }) }), d = new a.Mesh(u, o);
    d.receiveShadow = true, t.add(d);
  }
  {
    const l = cs(), f = new a.MeshBasicMaterial({ map: l, transparent: false });
    for (const [u, d] of [[_t, -Pt], [Pt, Nt]]) {
  ...
  for (const l of [-1, 1]) for (const [f, u] of [[_t, -Pt], [Pt, Nt]]) {
    const d = (A) => U(A) + l * O, h = (A) => U(A) + l * (O + K), p = Xt({ z0: f, z1: u, step: 1.6, a: (A) => ({ x: d(A), y: Lt }), b: (A) => ({ x: h(A), y: Lt }) }), m = new a.Mesh(p, l < 0 ? n : s);
  ...
  for (const l of [-1, 1]) {
    const f = Xt({ z0: _t, z1: Nt, step: 2, a: (d) => ({ x: U(d) + l * (O + K), y: 4e-3 }), b: (d) => ({ x: U(d) + l * (O + K + 3.4), y: 4e-3 }) }), u = new a.Mesh(f, c);
...
function un() {
  ...
  _.shutter = g({ color: 8226964, bands: 3, tint: 5265003 }), _.glass = P({ color: 4872816 }), _.grill = g({ color: 4934482, bands: 2, tint: 3816010 }), _.tank = g({ color: 3026483, bands: 3, tint: 3816010 }), _.awningA = g({ color: 13126460, bands: 3, tint: 8010298 }), _.awningB = g({ color: 3112299, bands: 3, tint: 2771530 }), _.ac = g({ color: 14210508, bands: 2, tint: 9079446 })), _;
}
function Ve(e, t) {
  const o = t.side || 1;
  un();
  ...
  if (m.rotation.x = Math.PI / 3, m.position.set(s - o * (i / 2 + 0.8), l + 0.55, r + c * 0.25), n.add(m), f) {
    ...
    const I = new a.Mesh(new a.BoxGeometry(0.12, 1, c * 0.92), k);
    I.position.set(s + o * 0.06, l - 1.45, r), n.add(I);
  }
  ...
  for (const y of [-c * 0.22, c * 0.22]) {
    ...
    for (let I = -2; I <= 2; I++) {
      ...
      v.position.set(s + o * 0.06, l - 2.6, r + y + I * 0.19), n.add(v);
    }
  }
...
function hs(e) {
  let t = 6;
  us.forEach((r, c) => {
    Ve(e, { x: U(t + 5 / 2) + ke, z: t + 5 / 2, w: 5, d: 7.2, h: c % 3 === 2 ? 4.6 : 6.4, wall: c, sign: r, awning: c % 2 === 0 ? "a" : c % 3 === 0 ? "b" : null, side: -1 }), t += 5 + 0.15;
  });
  ...
  let n = 42;
  o.forEach((r, c) => {
    Ve(e, { x: U(n + 5 / 2) - ke - 3.6, z: n + 5 / 2, w: 5, d: 7.2, h: 4.6, wall: c + 2, sign: r, awning: c === 0 ? "b" : null, side: 1 }), n += 5 + 0.15;
  });
  ...
  for (const r of s) Ve(e, { x: U(r.z) + (r.side > 0 ? -8.85 : ke), z: r.z, w: 5, d: 7.2, h: 4.6, wall: Math.abs(r.z | 0) % 8, sign: r.sign, awning: r.awning || null, side: r.side });
}
function ps(e) {
...
const So = O + K + 0.65, ce = 13, le = 41, J = 27, vt = 1.5;
function ms() {
...
function ws(e) {
  ...
  const o = U(J), n = o - So, s = o - So - 17, r = g({ color: 15327172, bands: 3, tint: 9077362 }), c = g({ color: 13194015, bands: 3, tint: 7027252 }), i = g({ color: 14180906, bands: 3, tint: 8010272 }), l = g({ color: 14715482, bands: 3, tint: 9062960 }), f = g({ color: 14198844, bands: 3, tint: 9071146, emissive: 6901268, emissiveIntensity: 0.25 }), u = P({ color: 1511435 }), d = g({ color: 11911876,
  ...
  for (const v of p) {
    const z = Math.max(v.x1 - v.x0, 0.35), R = Math.max(v.z1 - v.z0, 0.35), F = new a.Mesh(new a.BoxGeometry(z, h, R), r);
    F.position.set((v.x0 + v.x1) / 2, h / 2, (v.z0 + v.z1) / 2), t.add(F);
  ...
  [[16.5, 0, 1], [20.5, 1, 0.85], [33.5, 2, 0.95], [37.2, 3, 0.8]].forEach(([v, z, R], F) => {
    const H = new a.Mesh(new a.PlaneGeometry(0.8, R), new a.MeshBasicMaterial({ color: m[z] }));
    H.rotation.y = Math.PI / 2, H.position.set(n + 0.37, 1.05 + F % 2 * 0.15, v), t.add(H);
    const C = new a.Mesh(new a.PlaneGeometry(0.6, R * 0.3), new a.MeshBasicMaterial({ color: 15853776 }));
    C.rotation.y = Math.PI / 2, C.position.set(n + 0.375, 1 + F % 2 * 0.15, v), t.add(C);
  });
  for (const v of [-1, 1]) {
    const z = J + v * (vt + 0.5), R = new a.Mesh(new a.BoxGeometry(0.95, 3.2, 0.95), i);
    R.position.set(n + 0.18, 1.6, z), t.add(R);
    const F = new a.Mesh(new a.BoxGeometry(1.15, 0.22, 1.15), c);
    F.position.set(n + 0.18, 3.3, z), t.add(F), e.collide(n - 0.28, z - 0.5, n + 0.66, z + 0.5, 3.3);
  }
  ...
  for (const [v, z, R] of [[s + 2.5, ce + 3.5, 2.6], [n - 6.5, le - 2.2, 2.1]]) {
    const F = new a.Mesh(new a.CylinderGeometry(0.22, 0.3, 3.4, 8), g({ color: 5916210, bands: 3, tint: 3812898 }));
    F.position.set(v, 1.7, z), t.add(F);
  ...
  const I = new a.Mesh(new a.PlaneGeometry(2.3, 2.3), new a.MeshBasicMaterial({ map: xs(), transparent: true, depthWrite: false }));
  return I.rotation.x = -Math.PI / 2, I.position.set(n + 1.9, 0.062, J), I.renderOrder = 2, t.add(I), At(t), { gatePos: { x: n + 0.6, z: J } };
}
const at = {};
function hn() {
...
function ys(e = {}) {
  ...
  const f = new a.Mesh(new a.CylinderGeometry(0.205, 0.21, 0.62, 12, 1, true, -1, 2), P({ color: 16777215, map: Ko(o.int(0, 2)), cache: false, side: a.DoubleSide }));
...
const Bt = (e, t, o = 0) => new a.Vector3(e, t, o), gs = 0.018;
Bt(-0.52, 0.33 + gs), Bt(0.55, 0.33), Bt(-0.1, 0.28), Bt(-0.27, 0.86), Bt(0.44, 0.6), Bt(0.49, 0.86), Bt(0.46, 0.97), Bt(-0.31, 1);
function Ms(e) {
  const t = nt(9021), o = [], n = [];
  ...
  for (const c of n) {
    ...
    const i = U(c) + s * (O + K - 0.28), l = ys({ seed: c * 31 | 0, h: 8.6, armDir: -s });
  ...
  for (const c of [10, 26, 44, -16, -34]) {
    const i = U(c);
    r.push({ points: [new a.Vector3(i - (O + K - 0.28), 8.1, c), new a.Vector3(i + (O + K + 2.6), 6.4, c + 0.8)], sag: 0.7 });
  }
  r.push({ points: [new a.Vector3(U(-24) - 4.4, 7.9, -24), new a.Vector3(U(-6) - 4.5, 4.6, -6)], sag: 0.9 }), bs(e, r);
}
function zs(e) {
  const t = new a.Group(), o = -14, n = U(o) + O + K - 0.2, s = g({ color: 4877964, bands: 3, tint: 3820126 }), r = g({ color: 3626606, bands: 3, tint: 3029582 });
...
function vs(e) {
  ...
  for (const { z: o, side: n } of [{ z: 45, side: -1 }, { z: -20, side: 1 }]) {
    const s = U(o) + n * (O + K + 0.15), r = new a.Mesh(new a.CylinderGeometry(0.05, 0.05, 2.9, 8), t);
...
function Ss(e) {
  const t = nt(777), o = [{ x: -10.5, z: 20, s: 1.5, c: true }, { x: -13.5, z: 34, s: 1.35, c: true }, { x: -5.85, z: 22.5, s: 1.25, c: true }, { x: -5.7, z: -14, s: 1.1, c: true }, { x: O + K + 1.1, z: -27, s: 1, c: true }, { x: -5.9, z: -44, s: 1.2, c: true }, { x: O + K + 1, z: -58, s: 1, c: true }, { x: O + K + 1.2, z: 50, s: 1.1, c: true }, { x: -5.7, z: 52.5, s: 0.95, c: true }, { x: O + K +
...
function Go(e = {}) {
  ...
  {
    const f = P({ color: b.wallGray }), u = P({ color: 16777215, map: Bn(), cache: false }), d = new a.Mesh(new a.BoxGeometry(0.02, 0.13, 0.24), [f, u, f, f, f, f]);
  ...
  for (const f of [-1, 1]) i("dark", new a.CylinderGeometry(0.024, 0.024, 0.11, 6), T(r.BAR.x, r.BAR.y, f * 0.22, Math.PI / 2)), X(c.metal, N(0.36, 1.02, f * 0.18), N(0.32, 1.24, f * 0.24), 0.012), i("dark", new a.BoxGeometry(0.03, 0.11, 0.14), T(0.31, 1.26, f * 0.25)), n.add(D(8e-3, 0.09, 0.12, P({ color: b.mirrorFace }), 0.294, 1.26, f * 0.25)), i("amber", new a.BoxGeometry(0.06, 0.05, 0.05), T(
  0.45, 0.86, f * 0.19));
  if (i("metal", new a.CylinderGeometry(0.095, 0.095, 0.06, 14), T(0.48, 0.9, 0, 0, 0, Math.PI / 2)), n.add(Jt(0.082, 0.082, 0.02, 14, P({ color: 16774360 }), 0.514, 0.9, 0).rotateZ(Math.PI / 2)), e.cockpit) {
  ...
  return Rs(n, c, { dark: t.dark, metal: t.metal, body: l, amber: g({ color: b.orange, bands: 2, tint: 9396304 }), dial: P({ color: 15328986 }) }, { outline: "body", thickness: 34e-4 }), n.rotation.x = e.lean ?? -0.09, o.position.set(e.x, e.y ?? 0, e.z), o.rotation.y = e.ry ?? 0, o.userData.inner = n, o;
}
function Ye(e = {}) {
  const t = new a.Group(), o = new a.Group();
  t.add(o), t.userData.inner = o;
  const n = g({ color: e.color ?? 15251488, bands: 3, tint: 9071146 }), s = g({ color: 2302758, bands: 2, tint: 3816010 }), r = g({ color: 3026483, bands: 2, tint: 3816010 }), c = g({ color: 10133672, bands: 3, tint: 6051456 }), i = P({ color: 10338516, transparent: true, opacity: 0.55 }), l = { yellow: [], black: [], dark: [], metal: [] }, f = (p, m, w) => l[p].push({ geometry: m, matrix: w }), u = 0.25;
...
const To = new a.Vector3(), Ao = new a.Vector3(), Co = new a.Vector3(), Ro = new a.Matrix4(), Io = new a.Quaternion(), Eo = new a.Quaternion(), Bo = new a.Euler();
function $e(e, t, o, n, s) {
  te(t, o, To, Ao, Co), Ro.makeBasis(Ao, To, Co), Io.setFromRotationMatrix(Ro), Bo.set(0, s + Math.PI / 2, 0, "YXZ"), Eo.setFromEuler(Bo), e.quaternion.copy(Io).multiply(Eo), $t(t, n, o, e.position);
}
function Is(e) {
  ...
  for (const i of o) {
    const l = i.kind === "auto" ? Ye({ color: i.color }) : Go({ color: i.color });
  ...
  for (const i of n) {
    const l = U(i.z) + i.x * (O + 0.75), f = i.kind === "auto" ? Ye({ color: i.color, lean: -0.03 }) : Go({ color: i.color ?? 13227228 });
...
const Es = [13146474, 11896150, 11040328, 9857084], Bs = [13126460, 3112299, 14735560, 4026052, 14198844, 9400245, 15236e3, 15790312], Ps = [3817290, 4866616, 5921382, 3026483, 7035464];
function Po(e) {
  const t = new a.Group(), o = g({ color: e.pick(Es), bands: 3, tint: 9072478 }), n = g({ color: e.pick(Bs), bands: 3, tint: 7036528 }), s = g({ color: e.pick(Ps), bands: 2, tint: 3816010 }), r = g({ color: 2367518, bands: 2, tint: 3816010 }), c = e.range(0.92, 1.06), i = new a.Mesh(new a.BoxGeometry(0.34, 0.55, 0.2), n);
...
function Ds(e) {
  ...
  function r(c) {
    for (const i of o) {
      ...
      const f = U(i.z) + i.side * (O + K * 0.55), u = i.dir > 0 ? Math.PI : 0;
      $e(i.obj, f, i.z, Lt, u);
...
function Os(e) {
  ...
  const o = [], n = [], s = [], r = [], c = [], i = { scene: e, root: t, colliders: o, interactables: n, add: (x) => (t.add(x), x), collide: (x, S, y, k, I, v) => {
    o.push({ x0: Math.min(x, y), x1: Math.max(x, y), z0: Math.min(S, k), z1: Math.max(S, k), top: I, bottom: v });
    ...
    return y;
  }, interact: (x) => n.push(x), update: (x) => s.push(x) }, l = $n(e), f = Ka(i), u = es(i), d = Ns(i), h = os(i), p = 165, m = { blink: 0, armT: 0 };
  f.request = () => {
    u.x = gt(-153 * u.dir);
  };
  const w = [1, -1].map((x) => {
    const S = { x0: U(0) - O - 0.6, x1: U(0) + O + 0.6, z0: x * Se - 0.16, z1: x * Se + 0.16, top: -1 };
    return o.push(S), S;
  });
  function M(x) {
  ...
  return u.planetize(), { root: t, colliders: o, platforms: r, cuts: c, interactables: n, train: u, crossing: f, planet: l, petals: h, bakeStats: G, bounds: { z0: -ht * 0.24, z1: ht * 0.24 }, heightAt(x, S, y) {
    ...
    const I = y === void 0 ? 1 / 0 : y + 0.55;
    for (const v of r) v.top > I || x > v.x0 && x < v.x1 && S > v.z0 && S < v.z1 && (k = Math.max(k, v.top));
    return k;
  }, update(x) {
    M(x), u.update(x);
...
function Hs({ scene: e, world: t, player: o, hud: n }) {
  const s = Ye({ color: 15251488, lean: No }), r = s.userData.inner;
  s.visible = false, e.add(s);
  const c = new a.Mesh(new a.BoxGeometry(1.9, 1.35, 0.95), P({ color: 16711680, cache: false }));
  ...
  function G(C, L, V, E, B) {
    te(C, L, u, d, h), p.makeBasis(d, u, h), m.setFromRotationMatrix(p), M.set(0, E + Math.PI / 2, B, "YXZ"), w.setFromEuler(M), s.quaternion.copy(m).multiply(w), $t(C, V, L, s.position), s.updateMatrixWorld(true);
  }
  function A(C, L, V, E) {
    const B = -Math.sin(V), j = -Math.cos(V), lt = _o / 2, Re = t.heightAt(gt(C + B * lt), L + j * lt, E), oe = t.heightAt(gt(C - B * lt), L - j * lt, E);
    return a.MathUtils.clamp(Math.atan2(Re - oe, _o), -0.45, 0.45);
  }
  function x(C) {
    if (f) {
    ...
    if (!C) return;
    const L = Math.abs(Math.sin(l.heading)), V = Math.abs(Math.cos(l.heading)), E = Do * L + Lo * V, B = Do * V + Lo * L, j = t.heightAt(l.x, l.z, o.pos.y);
    f = { x0: l.x - E, x1: l.x + E, z0: l.z - B, z1: l.z + B, top: j + 1.02 }, t.colliders.push(f);
  }
  function S(C, L, V, E) {
    for (const B of t.colliders) if (B !== f && !(B.top !== void 0 && B.top <= E + Ws) && !(B.bottom !== void 0 && B.bottom > E + 1.9) && C > B.x0 - V && C < B.x1 + V && L > B.z0 - V && L < B.z1 + V) return false;
    return true;
  }
  function y(C) {
  ...
  function I() {
    ...
    for (const V of [2, 1.65, 2.6, 1.3]) {
      for (const E of [0, 0.45, -0.45, 0.95, -0.95, 1.6, -1.6]) {
        const B = gt(o.pos.x - Math.sin(o.yaw + E) * V), j = o.pos.z - Math.cos(o.yaw + E) * V;
        if (S(B, j, 0.8, C) && !(Math.abs(t.heightAt(B, j, C) - C) > 0.5)) {
          L = { x: B, z: j };
          break;
        }
      }
  ...
  function R() {
    ...
    const C = Math.cos(l.heading), L = -Math.sin(l.heading), V = -Math.sin(l.heading), E = -Math.cos(l.heading), B = o.pos.y, j = [[-C * 1.35, -L * 1.35], [C * 1.35, L * 1.35], [-V * 1.9, -E * 1.9]];
    for (const [lt, Re] of j) {
      const oe = gt(o.pos.x + lt), Ie = o.pos.z + Re;
      if (S(oe, Ie, Vs, B) && !(Math.abs(t.heightAt(oe, Ie, B) - B) > 0.6)) {
        o.pos.x = oe, o.pos.z = Ie;
        break;
      }
    }
  ...
  function F() {
    ...
    Math.hypot(Qo(l.x, o.pos.x), l.z - o.pos.z) > 4 ? I() : v();
  }
  function H() {
    if (!l.riding) return;
    const C = o.yaw, L = -Math.sin(C), V = -Math.cos(C), E = gt(o.pos.x + L * Ot.seatFwd), B = o.pos.z + V * Ot.seatFwd;
    G(E, B, o.pos.y, C, A(E, B, C, o.pos.y)), r.rotation.x = -o.roll * Fs, l.x = E, l.z = B, l.heading = C;
  }
  return { group: s, toggle: F, summon: I, recall: v, mount: z, dismount: R, update: H, get riding() {
    return l.riding;
  }, get summoned() {
    return l.out;
  } };
}
const Je = document.getElementById("view"), Ht = new a.WebGLRenderer({ canvas: Je, antialias: false, powerPreference: "high-performance", stencil: false });
Ht.setPixelRatio(1);
...
it.add(qt);
it.add(qt.target);
const Te = new a.HemisphereLight(b.hemiSky, b.hemiGround, 1.12);
it.add(Te);
const Oo = Nn(it, 500), de = Os(it), Y = new oa(ct, Je, de), pn = "nallakunta-forever-volume";
let to = 0.34;
try {
  const e = localStorage.getItem(pn);
  if (e !== null) {
    const t = Number(e);
    Number.isFinite(t) && (to = Math.max(0, Math.min(1, t)));
  }
} catch {
}
const q = na({ volume: to }), mt = aa({ volume: to, fadeIn: 3 });
q.setMuted(mt.muted);
const eo = () => {
  try {
...
q.onVolumeChange = (e) => {
  q.setMuted(mt.setVolume(e)), eo();
};
const mn = window.matchMedia?.("(pointer: coarse)").matches ?? false;
q.onStart = () => {
  mt.start(), mn ? (Y.touchActive = true, q.setLocked(true)) : Y.lock();
};
Y.onLockChange = (e) => q.setLocked(e);
Je.addEventListener("click", () => {
  mt.start(), !mn && !Y.locked && Y.lock();
});
window.addEventListener("nf-memory", (e) => q.showCard(e.detail));
q.bindTouch({ player: Y, onEnter: () => {
  Y.touchActive || q.onStart?.();
}, onPlanet: () => {
  Xe(!Wt), q.flash(Wt ? "orbit view  \xB7  \u25CE to return" : "back on the ground");
}, onMusic: () => {
  const e = mt.toggle();
  q.setMuted(e), q.setVolume(mt.volume), eo(), mt.available && q.flash(e ? "\u266A  music off" : "\u266A  music on");
} });
const fe = Hs({ scene: it, world: de, player: Y, hud: q });
Y.onInteract = (e) => {
  if (fe.riding) {
    fe.dismount();
    return;
...
let Wt = false, He = 0.6;
const Wo = new a.Vector3(), qs = it.fog, Ys = ct.far;
function Xe(e) {
  Wt = e, it.fog = e ? null : qs, ct.far = e ? 1600 : Ys, ct.updateProjectionMatrix();
  const t = Z.shadow.camera, o = e ? $ * 1.15 : 34;
  t.left = -o, t.right = o, t.top = o, t.bottom = -o, t.far = e ? $ * 6 : 200, t.updateProjectionMatrix(), q.setPlanetView(e);
}
window.addEventListener("keydown", (e) => {
  if (!e.repeat) {
    if (e.code === "KeyM") {
      const t = mt.toggle();
      q.setMuted(t), q.setVolume(mt.volume), eo(), mt.available && q.flash(t ? "\u266A  music off" : "\u266A  music on");
    }
    e.code === "KeyV" && (Wt ? (Xe(false), q.flash("back on the ground")) : fe.toggle()), e.code === "KeyP" && (Xe(!Wt), q.flash(Wt ? "orbit view  \xB7  P to return" : "back on the ground")), e.code === "KeyO" && (St.enabled.ink = !St.enabled.ink), e.code === "KeyG" && (St.enabled.grade = !St.enabled.grade);
  }
});
function wn() {
  const e = Math.min(Us.getDelta(), 0.05);
  if (Y.update(e), fe.update(e), de.update(e), Wt) He += e * 0.09, Wo.set(Math.sin(He) * 0.8, 1, Math.cos(He) * 0.8).normalize(), ct.position.copy(ot).addScaledVector(Wo, $ * 3.3), ct.up.set(0, 1, 0), ct.lookAt(ot), Z.target.position.copy(ot), Z.position.copy(ot).add(new a.Vector3(-1.05, 0.95, 0.75).multiplyScalar($ * 2.2)), Te.position.set(0, 1, 0), Me(ee, Vo, { east: new a.Vector3(1, 0, 0), up: new a.
  Vector3(0, 1, 0), north: new a.Vector3(0, 0, 1) }, ot), qt.visible = false;
  else {
    qt.visible = true;
    const o = te(Y.pos.x, Y.pos.z);
    $t(Y.pos.x, 0, Y.pos.z, ge), Me(Z, js, o, ge), Me(ee, Vo, o, ge), Me(qt, Ks, o, ge), Te.position.copy(o.up);
  }
  Oo.dome.position.copy(ct.position), Oo.clouds.position.copy(ct.position);
  const t = !Wt && Y.locked ? Y.pick(de.interactables) : null;
  q.setPrompt(t ? `E  \xB7  ${t.label.replace(/^.*?Â·\s*/, "")}` : ""), q.update(e, Y.locked), q.setCoords(Y.pos, Y.yaw, Y.pitch, e), St.render(), requestAnimationFrame(wn);
}
wn();
window.__scene = { scene: it, camera: ct, renderer: Ht, pipeline: St, world: de, player: Y, ebike: fe, music: mt, hud: q, sun: Z, fill: ee, bounce: qt, hemi: Te, THREE: a };
