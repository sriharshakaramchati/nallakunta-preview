...
function te(e, t) {
  ...
  if (p.position.set(n - r * 0.22, c + 0.85, u + f * (i / 2 - 0.7)), o.add(p), l) {
    ...
    z[f > 0 ? 4 : 5] = new a.MeshBasicMaterial({ map: m });
...
function Ds(e) {
  const t = st(777), o = [{ x: -10.5, z: 20, s: 1.5, c: true }, { x: -13.5, z: 34, s: 1.35, c: true }, { x: -5.85, z: 22.5, s: 1.25, c: true }, { x: -5.7, z: -14, s: 1.1, c: true }, { x: O + q + 1.1, z: -27, s: 1, c: true }, { x: -5.9, z: -44, s: 1.2, c: true }, { x: O + q + 1, z: -58, s: 1, c: true }, { x: O + q + 1.2, z: 56.5, s: 1.1, c: true }, { x: -5.7, z: 52.5, s: 0.95, c: true }, { x: O + q +
